...
#for showing signup/login button for admin(by  Amikom Purwokerto)
...
#for showing signup/login button for doctor(by  Amikom Purwokerto)
...
#for showing signup/login button for patient(by  Amikom Purwokerto)
...
#-----------for checking user is doctor , patient or admin(by  Amikom Purwokerto)
def is_admin(user):
...
#Developed By : Amikom Purwokerto
